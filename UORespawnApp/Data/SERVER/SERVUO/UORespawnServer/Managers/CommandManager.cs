...
namespace Server.Custom.UORespawnServer.Managers
{
    ...
    internal static class CommandManager
    {
        ...
        internal static string GetEditFilePath(CommandTarget target)
        {
            switch (target)
            {
                case CommandTarget.Settings:
                    return UOR_DIR.SETTINGS_EDIT_FILE;
                case CommandTarget.Box:
                    return UOR_DIR.BOX_EDIT_FILE;
                case CommandTarget.Region:
                    return UOR_DIR.REGION_EDIT_FILE;
                case CommandTarget.Tile:
                    return UOR_DIR.TILE_EDIT_FILE;
                case CommandTarget.Vendor:
                    return UOR_DIR.VENDOR_EDIT_FILE;
                default:
                    return null;
            }
        }
