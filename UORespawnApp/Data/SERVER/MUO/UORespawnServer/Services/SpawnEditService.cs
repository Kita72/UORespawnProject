...
internal class SpawnEditService
{
    ...
    private int GetGumpOffset()
    {
        ...
        {
            CommandTarget.Box => 0,
            CommandTarget.Region => 340,
            CommandTarget.Tile => 680,
            _ => 0,
        };
    }
    ...
    internal List<string> GetCurrentSpawnList()
    {
        ...
        {
            SpawnSection.Water => _WorkingWaterList,
            SpawnSection.Weather => _WorkingWeatherList,
            SpawnSection.Timed => _WorkingTimedList,
            SpawnSection.Common => _WorkingCommonList,
            SpawnSection.Uncommon => _WorkingUncommonList,
            SpawnSection.Rare => _WorkingRareList,
            _ => _WorkingCommonList,
        };
    }
    ...
    {
        int count = 0;
        List<string> originalList = original ?? [];
        List<string> workingList = working ?? [];
    ...
    private static SpawnTrigger GetTriggerForSection(SpawnSection section) => section switch
    {
        SpawnSection.Weather => SpawnTrigger.Weather,
        SpawnSection.Timed => SpawnTrigger.Timed,
        _ => SpawnTrigger.None,
    };
