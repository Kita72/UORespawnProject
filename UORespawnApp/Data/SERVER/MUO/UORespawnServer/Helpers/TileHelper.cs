...
internal static class TileHelper
{
    ...
    //Invalid
    private static readonly HashSet<int> InvalidTiles =
    [
        0x01B3, 0x01B4,
        0x01B5,
    ];
    ...
    //Grass
    private static readonly HashSet<int> GrassTiles =
    [
        0x3EF0, 0x3FF6,
        0x3FFC, 0x3FFD,
        0x3FFE, 0x3FFF,
    ...
    //Sand
    private static readonly HashSet<int> SandTiles =
    [
        0x0192, 0x3FF5, 0x3FF7,
    ];

    //Jungle
    private static readonly HashSet<int> JungleTiles =
    [
        0x00B2, 0x00B4,
        0x00B5, 0x00B7,
        0x00B8, 0x00BA,
    ...
    //Snow
    private static readonly HashSet<int> SnowTiles =
    [
        0x0119,
        0x3FEC, 0x3FED,
        0x3FEE, 0x3FEF,
    ...
    //Dirt
    private static readonly HashSet<int> DirtTiles =
    [
        0x03F8,
        0x079A, 0x079B,
        0x079C, 0x079D,
    ...
    //Swamp
    private static readonly HashSet<int> SwampTiles =
    [
        0x09C4, 0x09C5,
        0x09C6, 0x09C7,
        0x09C8, 0x09C9,
    ...
    //Tile
    private static readonly HashSet<int> TileTiles =
    [
        0x0200, 0x0205,
        0x0206, 0x0207,
        0x0208, 0x0209,
    ...
    //Marble
    private static readonly HashSet<int> MarbleTiles =
    [
        0x04E7, 0x04E8,
    ];

    //Wooden Floor
    private static readonly HashSet<int> WoodenFloorTiles =
    [
        0x04D6, 0x04D7,
        0x04DD, 0x04DF,
        0x04E0, 0x3CDD,
    ...
    //Sand Stone
    private static readonly HashSet<int> SandStoneTiles =
    [
        0x0501, 0x0502,
        0x0503, 0x0504,
        0x0505, 0x0506,
    ...
    //cloud
    private static readonly HashSet<int> CloudTiles =
    [
        0x3EED, 0x3EEE,
        0x3EEF, 0x3EF1,
    ];
    ...
    //Water Deep
    private static readonly HashSet<int> WaterDeepTiles =
    [
        0x00A8, 0x00AB,
        0x0136, 0x0137
    ];
    ...
    //Water Sand
    internal static readonly HashSet<int> WaterShallowTiles =
    // land below static water!
    [
        0x004C, 0x004D,
        0x004E, 0x004F,
        0x0050, 0x0051,
    ...
    //Invalid Names
    internal static readonly HashSet<string> InvalidTileNames =
    [
        "ED",
        "2017",
        "2028",
