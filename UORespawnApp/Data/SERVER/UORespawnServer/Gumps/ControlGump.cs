...
namespace Server.Custom.UORespawnServer.Gumps
{
    internal class ControlGump : Gump
    {
        ...
        private void BuildGump()
        {
            ...
            // === STATS SECTION ===
            //AddSectionHeader(0, y, "#-[ Dashboard ]-#");
            y += 30;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (buttonId)
            {
                ...
                case BTN_TOGGLE_DEBUG: _Service.ToggleDebug(); break;
                case BTN_TOGGLE_EFFECTS: _Service.ToggleEffects(); break;
                case BTN_TOGGLE_SCALE: _Service.ToggleScaleSpawn(); break;

                // Spawn Toggles
                case BTN_TOGGLE_TOWN: _Service.ToggleTownSpawn(); break;
                case BTN_TOGGLE_GRAVE: _Service.ToggleGraveSpawn(); break;
                case BTN_TOGGLE_RIFT: _Service.ToggleRiftSpawn(); break;
                case BTN_TOGGLE_VENDOR: _Service.ToggleVendorSpawn(); break;
                case BTN_TOGGLE_VENDOR_NIGHT: _Service.ToggleVendorNight(); break;
                case BTN_TOGGLE_VENDOR_EXTRA: _Service.ToggleVendorExtra(); break;

                // Scale & Limits
                case BTN_SCALE_DOWN: _Service.AdjustScaleMod(-0.1); break;
                case BTN_SCALE_UP: _Service.AdjustScaleMod(0.1); break;
                case BTN_MAXSPAWN_DOWN: _Service.AdjustMaxSpawn(-1); break;
                case BTN_MAXSPAWN_UP: _Service.AdjustMaxSpawn(1); break;
                case BTN_MINRANGE_DOWN: _Service.AdjustMinRange(-1); break;
                case BTN_MINRANGE_UP: _Service.AdjustMinRange(1); break;
                case BTN_MAXRANGE_DOWN: _Service.AdjustMaxRange(-5); break;
                case BTN_MAXRANGE_UP: _Service.AdjustMaxRange(5); break;
                case BTN_MAXCROWD_DOWN: _Service.AdjustMaxCrowd(-1); break;
                case BTN_MAXCROWD_UP: _Service.AdjustMaxCrowd(1); break;
                case BTN_MAXQUEUE_DOWN: _Service.AdjustMaxQueueSize(-1); break;
